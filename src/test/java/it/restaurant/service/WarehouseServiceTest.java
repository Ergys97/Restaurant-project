...
class WarehouseServiceTest {
    ...
    void depletedItemIsRestocked() {
        ...
        new WarehouseService(new JsonDataStore(tempDir), new DataStoreTransaction()).restock(items, TODAY);
    ...
    void expiredItemGetsNewFutureExpiryDate() {
        ...
        new WarehouseService(new JsonDataStore(tempDir), new DataStoreTransaction()).restock(new ArrayList<>(List.of(expired)), TODAY);
    ...
    void healthyItemIsUntouched() {
        ...
        new WarehouseService(new JsonDataStore(tempDir), new DataStoreTransaction()).restock(new ArrayList<>(List.of(ok)), TODAY);
